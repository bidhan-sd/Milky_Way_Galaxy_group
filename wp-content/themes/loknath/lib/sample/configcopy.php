<?php
    ...
    */
    ...
    Redux::setSection($opt_name,array(
        'title' => __('Essential fields','zboom'),        
        'icon' => 'el el-picture',
        'fields' => array(
            array(
                'title' => __('Logo uploader','zboom'),
                'desc' => __('Upload your logo here 16 x 16 px','zboom'),
                'id' => 'logo-upload',
                'type' => 'media',
                'compiler' => true,
                'default' => array(
                    'url' => get_template_directory_uri().'/img/head1.png',
                ),
            ),
            array(
                'title' => __('Footer text','zboom'),
                'desc' => __('You insert your footer text here as your wish','zboom'),
                'id' => 'footer-text',
                'type' => 'text', 
            ),
        ),
