<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'loknath options', 'redux-framework-demo' ),
        'page_title'           => __( 'loknath Options', 'redux-framework-demo' ),
    ...
    // -> START Basic Fields
     ...
     Redux::setSection( $opt_name, array(
        'title' => __( 'Essential fields', 'loknath' ),
        'icon' => 'el el-picture',
        'fields' => array(
                array(
                'title' => __('logo uploder','loknath'),
                'desc'  =>__('May you upload your logo','loknath'),
                'id' => 'upload-logo',
                'type' => 'media',
                'compiler' => true,
                'default' => array(
                    'url' => get_template_directory_uri().'/img/logo6.png',
                ),               
            ), 
            array(
                'title' => __('Logo visibility','loknath'),
                'type' => 'button_set',
                'id' => 'logo-visible',
                'options' => array(
                    '0' => "Hide",
            ...
            array(
                'title' => __('Footer text','loknath'),
                'desc' => __('You insert your footer text here as your wish','loknath'),
                'id' => 'footer-text',
                'type' => 'text', 
             ),
        ),
        ...
        'fields' => array(
            array(
                ...
                'default' => array(
                    ...
                    'background-image' => get_template_directory_uri().'/img/head1.png',
    ...
    Redux::setSection($opt_name,array(
        'title' => __('Contact Page','loknath'),
        'icon' => 'el el-barcode',
        'fields' => array(
                array(
                'title' => __('Contact page quout','loknath'),
                'desc' => __('You insert baba loknath statement text here','loknath'),
                'id' => 'contactlok-statement',
                'type' => 'editor', 
            ),   
        ), 
    ));
    Redux::setSection($opt_name, array(
        'title' => __('Website layout','loknath'),
        'icon' => 'el el-website',
        'fields' => array(
            array(
                'title' => __('Select website layout','loknath'),
                'id' => 'website-layout',
                'type' => 'image_select',
                'options' => array(
    ...
    Redux::setSection($opt_name,array(
        'title' => __('Video page','loknath'),
        'icon' => 'el el-video', 
        'fields' => array(
                array(
                    'title' => __('Video page title','loknath'),
                    'desc' => __('You insert your video title here','loknath'),
                    'id' => 'lok_video_title',
                    'type' => 'text', 
                    'default' => 'Our celebration video',
                ),
                array(
                'id'          => 'lokvideoitem',
                'type'        => 'slides',
                'title'       => __('Video Options', 'loknath'), 
                'subtitle'    => __('Unlimited video with drag and drop.', 'loknath'),
                'desc'        => __('This field will store all video values here','loknath'),
                'placeholder' => array(
                    'title'           => __('This is a title', 'loknath'),
                    'description'     => __('Description Here', 'loknath'),
                    'url'             => __('Give us a link!', 'loknath'),
                ),
            ), 
    ...
    Redux::setSection($opt_name,array(
        'title' => __('Footer top option','loknath'),
        'icon' => 'el el-view-mode', 
        'fields' => array(
            array(
                'title' => __('footer widget','loknath'),
                'desc' => __('Put you Slogan here','loknath'),
                'id' => 'footer_widget_slogan',
                'type' => 'text', 
                'default' => 'we are loknath youth service association child',
            ),
            array( 
                'id' => 'divderone',
                'type' => 'divide',  
            ...
            array(
                'title' => __('footer social icon','loknath'),
                'desc' => __('Put your social link','loknath'),
                'id' => 'lok_social_link',
                'type' => 'text',
                'options' => array(
                    '1' => 'Facebook',
  ...
  Redux::setSection($opt_name,array(
        'title' => __('Font page option','loknath'),
        'icon' => 'el el-home', 
        'fields' => array(
            array(
                'title' => __('Fontpage content header','loknath'), 
                'id' => 'fontpage_content_header',
                'type' => 'text', 
                'default' => 'Welcome to Our loknath Youth Services Assocation',
            ),
            array( 
                'id' => 'divderone',
                'type' => 'divide',  
            ...
            array(
                'title' => __('Fontpage content','loknath'), 
                'id' => 'fontpage_content',
                'type' => 'editor', 
            ),
            array( 
            ...
            array(
                'title' => __('Fontpage sidebar header','loknath'), 
                'id' => 'fontpage_sidebar_header',
                'type' => 'text', 
                'default' => 'Religon site',
            ),
            array( 
                'id' => 'divderthree',
                'type' => 'divide',  
            ...
            array(
                'title' => __('Fontpage right sidebar','loknath'),
                'desc' => __('Put your religion artical link','loknath'),
                'id' => 'fontpage_sidebar_link',
                'type' => 'text',
                'options' => array(
                    '1' => 'Religion book',
                    '2' => 'Religion mp3',
